...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/CycloneScreenMinaret/">CycloneScreenMinaret</a><a href="https://github.com/CycloneScreenMinaret/discordzapret">/discordzapret</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />
...
<!-- gbzap-pages-link -->
**Страница сборки:** [https://cyclonescreenminaret.github.io/discordzapret/](https://cyclonescreenminaret.github.io/discordzapret/)

> [!CAUTION]
>
> ### ФЕЙКИ
> Я не веду никакие другие страницы/группы в телеграм/ютуб каналы  
> Если вы наткнулись на что-то вне репозитория `CycloneScreenMinaret/discordzapret`, что распространяется от моего лица - **ФЕЙК**.
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/CycloneScreenMinaret/discordzapret/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/CycloneScreenMinaret/discordzapret/issues/522)
...
- См. [#765](https://github.com/CycloneScreenMinaret/discordzapret/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/CycloneScreenMinaret/discordzapret/releases/latest) (`zapret-discord-youtube-...`)
...
- См. также [#251](https://github.com/CycloneScreenMinaret/discordzapret/discussions/251)
...
- См. также [#252](https://github.com/CycloneScreenMinaret/discordzapret/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/CycloneScreenMinaret/discordzapret/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/CycloneScreenMinaret/discordzapret/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/CycloneScreenMinaret/discordzapret/blob/main/LICENSE.txt)

## 🩷Благодарность участникам проекта

](https://github.com/CycloneScreenMinaret/discordzapret/graphs/contributors)
